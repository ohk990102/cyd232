...
{
  {0xFC632551, 0xF3B9CAC2, 0xA7179E84, 0xBCE6FAAD, 0xFFFFFFFF, 0xFFFFFFFF, 0x00000000, 0xFFFFFFFF }, 8
};
...
int ECC_BN_shift_sub_mod(ECC_BN *c, ECC_BN *a, ECC_BN *p); // c = a mod p
...
int ECC_BN_binary_inv(ECC_BN* c, ECC_BN* a, ECC_BN* p); // c= a^(-1) mod p 
...
int ECC_point_smul(ECC_POINT* R, ECC_BN* k, ECC_POINT* P);               //kP=R
